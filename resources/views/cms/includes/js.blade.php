<script !src="">
    ...
    $(document).on('click','.activate-payment',function(e) {
        e.preventDefault();
        Pay = $(this).data('user');
        $('#edit-transaction').val(Pay.transactioncode);
   ...
   $(document).on('submit','#edit-transaction',function(e){
       e.preventDefault();
       var dat = '{"transaction":"'+ $('#edit-transaction').val()+'","phone":"'+$('#edit-sender_phone').val()+'","mpesa_code":"'+$("#edit-mpesa_code").val()+'","amount_received":"'+$('#edit-amount').val()+'"}';
       console.log(dat);
       $.ajax({
           type: 'POST',
