                ...
                <div className="row justify-content-between align-items-center">
                    <div
                        ...
                        <div className="d-inline-block">
                            <h5 className="h4 d-inline-block font-weight-400 mb-0 text-white">Select Subject</h5>
                        </div>
                    </div>
                                        ...
                                        <div className='row'>
                                            {
                                                subjects.map((el) => {
                                                    return (
                                                        <Link className="btn btn-square text-sm " to={`${DIR}/exams/subjects/${el.id}/modules`}>
                                                        <span className="btn-inner--icon d-block">
                                                            <i className="fa fa-tasks fa-2x" />
                                                        </span>
                                                            <span className="btn-inner--icon d-block pt-2">{el.subject}</span>
                                                        </Link>
                                                    )
                                                })
                                            }
